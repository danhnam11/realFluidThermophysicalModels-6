...
namespace Foam
{
    ...
    makeReactions(idKineticHThermoPhysics, idKineticHReaction) //
    makeReactions(chungTakaRealJsrkHThermoPhysics, chungTakaRealJsrkHReaction) //
    makeReactions(chungKineticRealJsrkHThermoPhysics, chungKineticRealJsrkHReaction) //
    makeReactions(chungTakaRealJprHThermoPhysics, chungTakaRealJprHReaction) //
    makeReactions(chungKineticRealJprHThermoPhysics, chungKineticRealJprHReaction) //
    makeReactions
    (
    ...
    makeReactions(idKineticEThermoPhysics, idKineticEReaction) //
    makeReactions(chungTakaRealJsrkEThermoPhysics, chungTakaRealJsrkEReaction) //
    makeReactions(chungKineticRealJsrkEThermoPhysics, chungKineticRealJsrkEReaction) //
    makeReactions(chungTakaRealJprEThermoPhysics, chungTakaRealJprEReaction) //
    makeReactions(chungKineticRealJprEThermoPhysics, chungKineticRealJprEReaction) //

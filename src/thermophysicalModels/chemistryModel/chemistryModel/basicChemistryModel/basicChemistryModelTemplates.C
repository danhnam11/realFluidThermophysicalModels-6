...
License
    ...
    -----  
    This file has been modified enable to read other chemistry models
...
)
{
    ...
    (
        ...
        (
          ...
          ? "TDAC"
          : chemistryTypeDict.lookupOrDefault<bool>("SRKchungTakaStandard", false)    //
          ? "SRKchungTakaStandard"                                                    //
          : chemistryTypeDict.lookupOrDefault<bool>("SRKchungKineticStandard", false) //
          ? "SRKchungKineticStandard"                                                 //
          : chemistryTypeDict.lookupOrDefault<bool>("PRchungTakaStandard", false)     //
          ? "PRchungTakaStandard"                                                     //
          : chemistryTypeDict.lookupOrDefault<bool>("PRchungKineticStandard", false)  //
          ? "PRchungKineticStandard"                                                  //
          : chemistryTypeDict.lookupOrDefault<bool>("idKineticStandard", false)       //
          ? "idKineticStandard"                                                       //
          : "standard"
        )
    );

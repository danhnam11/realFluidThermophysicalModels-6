...
makeChemistryReader(idKineticHThermoPhysics); //
makeChemistryReader(chungTakaRealJsrkHThermoPhysics); //
makeChemistryReader(chungKineticRealJsrkHThermoPhysics); //
makeChemistryReader(chungTakaRealJprHThermoPhysics); //
makeChemistryReader(chungKineticRealJprHThermoPhysics); //
...
makeChemistryReaderType(foamChemistryReader, idKineticHThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungTakaRealJsrkHThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungKineticRealJsrkHThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungTakaRealJprHThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungKineticRealJprHThermoPhysics); //
...
makeChemistryReader(idKineticEThermoPhysics); //
makeChemistryReader(chungTakaRealJsrkEThermoPhysics); //
makeChemistryReader(chungKineticRealJsrkEThermoPhysics); //
makeChemistryReader(chungTakaRealJprEThermoPhysics); //
makeChemistryReader(chungKineticRealJprEThermoPhysics); //
...
makeChemistryReaderType(foamChemistryReader, idKineticEThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungTakaRealJsrkEThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungKineticRealJsrkEThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungTakaRealJprEThermoPhysics); //
makeChemistryReaderType(foamChemistryReader, chungKineticRealJprEThermoPhysics); //
makeChemistryReaderType
(
    foamChemistryReader,

...
Foam::PRchungKineticReactingMixture<ThermoType>::PRchungKineticReactingMixture
(
...
:
    ...
    PRchungKineticMixture<ThermoType>
    (
        thermoDict,
        *this,
...
template<class ThermoType>
void Foam::PRchungKineticReactingMixture<ThermoType>::read(const dictionary& thermoDict)
{}

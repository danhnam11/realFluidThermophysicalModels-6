...
Foam::SRKchungTakaReactingMixture<ThermoType>::SRKchungTakaReactingMixture
(
...
:
    ...
    SRKchungTakaMixture<ThermoType>
    (
        thermoDict,
        *this,
...
template<class ThermoType>
void Foam::SRKchungTakaReactingMixture<ThermoType>::read(const dictionary& thermoDict)
{}

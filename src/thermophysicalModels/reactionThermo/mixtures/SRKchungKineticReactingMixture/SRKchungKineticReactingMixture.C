...
Foam::SRKchungKineticReactingMixture<ThermoType>::SRKchungKineticReactingMixture
(
...
:
    ...
    SRKchungKineticMixture<ThermoType>
    (
        thermoDict,
        *this,
...
template<class ThermoType>
void Foam::SRKchungKineticReactingMixture<ThermoType>::read(const dictionary& thermoDict)
{}

...
Foam::idKineticReactingMixture<ThermoType>::idKineticReactingMixture
(
...
template<class ThermoType>
void Foam::idKineticReactingMixture<ThermoType>::read(const dictionary& thermoDict)
{}
